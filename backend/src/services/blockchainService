...
async function registerInvoiceOnChain({ invoiceId, invoiceHash, payer, providerName, originalAmountUSD, dueDate, category }) {
  ...
  const hash = await walletClient.writeContract({
    ...
    args: [invoiceId, invoiceHash, payer, walletClient.account.address, amount, BigInt(dueDate), providerName, category],
  });
