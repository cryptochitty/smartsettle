        ...
        <div className="mx-auto max-w-6xl px-6 flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[10px] text-muted tracking-widest font-mono">AUTONOMOUS BILL AGENT · CELO SEPOLIA</div>
            </div>
          </div>
        ...
        {!isConnected ? (
          <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 animate-fade-up text-center">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-xs text-muted">Supports Valora · MetaMask · WalletConnect</p>
            </div>
          </div>
        ) : (
          <>
