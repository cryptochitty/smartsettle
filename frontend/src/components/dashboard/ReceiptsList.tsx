...
export function ReceiptsList() {
  ...
  // Safely determine explorer base only on the client
  ...
  // Prevent server-side rendering of date/chain-specific UI
  if (!mounted) {
    return <div className="animate-pulse bg-surface border border-border rounded-2xl h-40" />;
  }
